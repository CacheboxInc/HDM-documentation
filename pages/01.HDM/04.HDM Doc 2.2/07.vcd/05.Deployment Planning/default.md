...
To deploy the HDM solution on  IBM Cloud for VMware Solutions Shared (VCD) you would
need to

* Get the _Organization Administrator_ access credentials to the IBM Cloud for VMware Solutions Shared (VCD) tenant portal.
