...
*   **On Cloud WAN network details**
    ...
    *   **On-Cloud WAN gateway :** On cloud WAN gateway which allows access to on-premise WAN subnet. This should be the IP address of PFSense server on cloud which is connected to Uplink_WAN_Network.
