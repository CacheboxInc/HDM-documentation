...
HDM HDM_VERSION is used to migrate VMs from on-premises environments to the cloud. There are two main use cases for HDM migrations:
...
_Figure 2: Location of HDM HDM_VERSION components_
